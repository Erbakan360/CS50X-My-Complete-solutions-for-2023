...
An interactive project built using Scratch, a block-based visual programming language. This project introduces fundamental programming concepts such as loops, variables, conditions, and event handling without the complexity of traditional syntax.
